...
import replugged from '../assets/replugged.png'
import repluggedSvg from '../assets/replugged.svg?file'
  ...
  return (
    <main>
      ...
      <p>Please keep all assets in their original shape, proportion, orientation and colors. You are not allowed to
        ...
        endorsement.</p>
      <p>Replugged is spelled with a capital P and all lowercase letters. It may also be spelled all uppercase.</p>
      ...
      <div className={style.assets}>
        <Asset
          ...
          links={[
            { name: 'plug.png', url: replugged },
            { name: 'plug.svg', url: repluggedSvg },
          ]}
        />
        <Asset
          name='Replugged Outlet'
          copyrightYear={2019}
          copyrightHolder='Katlyn Lorimer'
          links={[
      ...
      <h3>Meme branding</h3>
      <p>Those logos are <b>not</b> meant for usage. We don't mind them being used for Replugged-related content,
        but do not use them as official ways of representing Replugged and its brand.</p>
