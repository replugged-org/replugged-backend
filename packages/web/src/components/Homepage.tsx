    ...
    <main>
      ...
      <div className={style.featuresOld}>
        <FeatureOld
          icon={Feather}
          title='Lightweight'
          desc={'Replugged is designed to use low to no extra resources. You won\'t even notice it\'s here!*'}
        />
        <FeatureOld
          icon={Home}
      ...
      <p className={style.note}>
        *Replugged still runs on top of the official Discord client, so it won't magically make it consume less
        memory or CPU. However, we try our best to not consume even more resources.
      </p>
      <div className={style.installOld}>
        <h2>What are you waiting for???</h2>
        <p>Make your Discord spicier. <a href={Routes.INSTALLATION}>Install Replugged!</a></p>
      </div>
    </main>
  )
}
    ...
    <main className={style.container}>
      ...
      <div className={style.wrapper}>
        ...
        <section className={style.section}>
          ...
          <p className={style.sectionDescription}>
            Replugged gives plugins and theme developers the tools they need to build their next amazing plugin or
            theme.
          </p>
          <div className={style.features}>
            <Feature
              ...
              description={'Don\'t struggle with basic setup or boilerplate code. Replugged already provides everything you need to get started and do your patchwork.'}
