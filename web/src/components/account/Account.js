...
function LinkedAccount({ platform, icon, account, explainer, refreshEndpoint }) {
    ...
    return (<div className={style.linkedAccount}>
        ...
        <a native href={Endpoints.UNLINK_ACCOUNT(platform)} className={style.linkedAccountAction}>
                    ...
                    {!refreshing && account && refreshEndpoint && (<button className={`${sharedStyle.buttonLink} ${style.linkedAccountAction}`} onClick={refresh}>
                            <Refresh />
                            <span>Refresh</span>
                        </button>)}
    ...
    return (<main>
            ...
            <div className={style.columns}>
                <div className={style.linkedAccounts}>
                    ...
                    <LinkedAccount platform='spotify' icon={Spotify} account={user.accounts.spotify} explainer={'Linking your Spotify account gives you an enhanced experience with the Spotify plugin. It\'ll let you add songs to your Liked Songs, add songs to playlists, see private playlists and more.'}/>
            ...
            : <Fragment>
                    ...
                    {deletingAccount && (<Modal title="Delete my account" onClose={() => setDeletingAccount(false)} onConfirm={() => (location.pathname = Endpoints.YEET_ACCOUNT)} closeText='Cancel' confirmText='Delete' color='red'>
