      ...
      <div className={style.heading}>
        <div className={style.wrapper}>
          ...
          <p className={style.motto}>
            Enhance your Discord experience with new features and looks. Replugged makes your
            Discord truly <span class={style.italic}>yours</span>.
          </p>
      ...
      <div className={style.wrapper}>
        <section className={style.section}>
          ...
          <p className={style.sectionDescription}>
            Replugged has everything you need to enhance your Discord client, without compromising
        ...
        {/* <section className={style.section}>
                ...
                <hr /> */}
        <section className={style.section}>
          <h2 className={style.sectionTitle}>Make your Discord yours</h2>
          <p className={style.sectionDescription}>
