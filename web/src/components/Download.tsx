	...
	return (
		<div className={style.codeContainer}>
			...
			>
				...
				{copied ? (
					<Check
						className={`${sharedStyle.icon} ${style.copyCheck}`}
					/>
				) : (
		...
		},
		{
			...
			warning: (
				<>
					...
					<a href="#manual">manual installation instructions</a>.
				</>
			),
			files: [
				{
				...
				<section id="manual" className={style.manual}>
					...
					<p>
						<ol>
							...
							<li>
								<code>cd</code> into the repository:{' '}
								<Code>cd replugged</Code>
							</li>
							<li>
							...
							<li>
								...
								<br />
								If you want to specify into a specific Discord
								version, you can add the platform as an
								argument:{' '}
								<Code>
						...
						You can verify it's installed by going into Discord
						settings and looking for the "Replugged" tab.
					</p>
					<h3>Troubleshooting</h3>
					<p>
						If you're having issues, please reinstall Discord and
						try steps 5-7 again.
						<br />
						<br />
						...
						with any errors you're getting and any other information
