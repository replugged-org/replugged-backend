  ...
  return (
    <main className={`${style.markdown} serious`}>
      ...
      <p>
        ...
        https://replugged.dev/ website (the "Service") operated by Replugged ("us", "we", or "our").
      </p>
      <p>
      ...
      <p>
        ...
        any part of the terms then you may not access the Service. The Terms of Service agreement
        for Replugged has been created with the help of{" "}
        <a href="https://termsfeed.com/">TermsFeed</a>.
      </p>
      ...
      <p>
        ...
        controlled by Replugged.
      </p>
      <p>
        Replugged has no control over, and assumes no responsibility for, the content, privacy
        policies, or practices of any third party web sites or services. You further acknowledge and
        agree that Replugged shall not be responsible or liable, directly or indirectly, for any
