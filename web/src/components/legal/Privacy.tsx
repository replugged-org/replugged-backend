...
export default function Privacy(): VNode {
  ...
  return (
    <main className={`${style.markdown} serious`}>
      ...
      <p>
        Replugged ("us", "we", or "our") operates the https://replugged.dev/ website (the
        "Service").
      </p>
      <p>
        This page informs you of our policies regarding the collection, use, and disclosure of
        personal data when you use our Service and the choices you have associated with that data.
        Our Privacy Policy for Replugged is created with the help of the{" "}
      ...
      <p>
        ...
        Terms and Conditions, accessible from https://replugged.dev/
      </p>
      ...
      <p>
        Replugged will take all steps reasonably necessary to ensure that your data is treated
      ...
      <p>
        Replugged may disclose your Personal Data in the good faith belief that such action is
        necessary to:
      </p>
      <ul>
      ...
      <p>
        ...
        13. If you are a parent or guardian and you are aware that your Children has provided us
